...
HTTP contract for the Lythaus API. The active runtime is Cloudflare Workers backed by PlanetScale PostgreSQL through Hyperdrive. Initial authentication is Guest plus Email only. Production releases are coordinated from one reviewed main SHA; the release manifest and provider evidence remain outside this HTTP contract.
...
[*AdminApi*](doc/AdminApi.md) | [**adminUserDelete**](doc/AdminApi.md#adminuserdelete) | **DELETE** /admin/users/{userId} | Request controlled account deletion
[*AdminApi*](doc/AdminApi.md) | [**adminUserDetail**](doc/AdminApi.md#adminuserdetail) | **GET** /admin/users/{userId} | Read a user and account activity
[*AdminApi*](doc/AdminApi.md) | [**adminUserInvite**](doc/AdminApi.md#adminuserinvite) | **POST** /admin/users | Invite a new email account
[*AdminApi*](doc/AdminApi.md) | [**adminUserProfilePatch**](doc/AdminApi.md#adminuserprofilepatch) | **PATCH** /admin/users/{userId} | Edit a user profile
[*AdminApi*](doc/AdminApi.md) | [**adminUserResendVerification**](doc/AdminApi.md#adminuserresendverification) | **POST** /admin/users/{userId}/resend-verification | Request a new verification message
[*AdminApi*](doc/AdminApi.md) | [**adminUserRevokeSessions**](doc/AdminApi.md#adminuserrevokesessions) | **POST** /admin/users/{userId}/revoke-sessions | Revoke all active sessions
[*AdminApi*](doc/AdminApi.md) | [**adminUsersList**](doc/AdminApi.md#adminuserslist) | **GET** /admin/users | List users with keyset pagination
...
[*AdminApi*](doc/AdminApi.md) | [**adminWaitlistCreate**](doc/AdminApi.md#adminwaitlistcreate) | **POST** /admin/waitlist | Add a waitlist signup
[*AdminApi*](doc/AdminApi.md) | [**adminWaitlistDelete**](doc/AdminApi.md#adminwaitlistdelete) | **DELETE** /admin/waitlist/{waitlistId} | Retire a waitlist signup
...
## Documentation For Models
 ...
 - [AdminUserInvite](doc/AdminUserInvite.md)
 - [AdminUserMutationResponse](doc/AdminUserMutationResponse.md)
 ...
 - [WaitlistAdminItemLinkedAccount](doc/WaitlistAdminItemLinkedAccount.md)
