...
class ModerationApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [FlagCreateResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<FlagCreateResponse>> contentFlagsCreate({
    required FlagCreateRequest flagCreateRequest,
    ...
    try {
      const _type = FullType(FlagCreateRequest);
      _bodyData = _serializers.serialize(flagCreateRequest, specifiedType: _type);
    ...
    FlagCreateResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(FlagCreateResponse),
      ) as FlagCreateResponse;
    ...
    return Response<FlagCreateResponse>(
      data: _responseData,
  ...
  /// Returns a [Future] containing a [Response] with a [FlagCreateResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<FlagCreateResponse>> flagsCreate({
    required FlagCreateRequest flagCreateRequest,
    String? idempotencyKey,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
