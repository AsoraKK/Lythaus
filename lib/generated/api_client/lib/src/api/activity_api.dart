...
class ActivityApi {
  ...
  Future<Response<ActivityPage>> activityList({
    String? cursor,
    int? limit = 25,
    String? category,
  ...
  Future<Response<ActivityPage>> activityListLegacy({
    String? cursor,
    int? limit = 25,
    String? category,
    CancelToken? cancelToken,
    ...
    final _path = r'/users/me/activity';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ProductIntegrityPrivateProfileResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ProductIntegrityPrivateProfileResponse>> productIntegrityProfileGetMe({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    ProductIntegrityPrivateProfileResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ProductIntegrityPrivateProfileResponse),
      ) as ProductIntegrityPrivateProfileResponse;
    ...
    return Response<ProductIntegrityPrivateProfileResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [ProductIntegrityPrivateProfileResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ProductIntegrityPrivateProfileResponse>> productIntegrityProfileReplaceMe({
    required ProductIntegrityProfileUpdateRequest productIntegrityProfileUpdateRequest,
    ...
    try {
      const _type = FullType(ProductIntegrityProfileUpdateRequest);
      _bodyData = _serializers.serialize(productIntegrityProfileUpdateRequest, specifiedType: _type);
  ...
  /// Returns a [Future] containing a [Response] with a [ProductIntegrityPrivateProfileResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ProductIntegrityPrivateProfileResponse>> productIntegrityProfileUpdateMe({
    required ProductIntegrityProfileUpdateRequest productIntegrityProfileUpdateRequest,
    String? idempotencyKey,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
