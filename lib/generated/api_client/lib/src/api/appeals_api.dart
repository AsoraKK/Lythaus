...
import 'package:lythaus_api_client/src/model/appeal_create_request.dart';
...
class AppealsApi {
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [AppealReviewerAssignments] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AppealReviewerAssignments>> appealReviewerAssignmentsList({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/appeals/reviewer/assignments';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    AppealReviewerAssignments? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(AppealReviewerAssignments),
      ) as AppealReviewerAssignments;
    ...
    return Response<AppealReviewerAssignments>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [AppealCreateResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AppealCreateResponse>> appealsCreate({
    required AppealCreateRequest appealCreateRequest,
    ...
    try {
      const _type = FullType(AppealCreateRequest);
      _bodyData = _serializers.serialize(appealCreateRequest, specifiedType: _type);
    ...
    AppealCreateResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(AppealCreateResponse),
      ) as AppealCreateResponse;
    ...
    return Response<AppealCreateResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [AppealDetailResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AppealDetailResponse>> appealsGet({
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    AppealDetailResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(AppealDetailResponse),
      ) as AppealDetailResponse;
    ...
    return Response<AppealDetailResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [AppealRecusalResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AppealRecusalResponse>> appealsRecuse({
    ...
    final _path = r'/appeals/{appealId}/recuse'.replaceAll('{' r'appealId' '}', encodeQueryParameter(_serializers, appealId, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
    ...
    AppealRecusalResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(AppealRecusalResponse),
      ) as AppealRecusalResponse;
    ...
    return Response<AppealRecusalResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GovernanceAppealVoteResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GovernanceAppealVoteResponse>> appealsVote({
    required String appealId,
    required String idempotencyKey,
    required GovernanceAppealVoteRequest governanceAppealVoteRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/appeals/{appealId}/vote'.replaceAll('{' r'appealId' '}', encodeQueryParameter(_serializers, appealId, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        r'Idempotency-Key': idempotencyKey,
    ...
    try {
      const _type = FullType(GovernanceAppealVoteRequest);
      _bodyData = _serializers.serialize(governanceAppealVoteRequest, specifiedType: _type);
    ...
    GovernanceAppealVoteResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(GovernanceAppealVoteResponse),
      ) as GovernanceAppealVoteResponse;
