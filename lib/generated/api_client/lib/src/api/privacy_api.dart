...
class PrivacyApi {
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltMap<String, JsonObject>>> privacyRequestExportDownload({
    ...
    final _path = r'/privacy/requests/{requestId}/export'.replaceAll('{' r'requestId' '}', encodeQueryParameter(_serializers, requestId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
