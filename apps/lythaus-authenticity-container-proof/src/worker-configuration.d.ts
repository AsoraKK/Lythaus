/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.container-proof.example.jsonc src/worker-configuration.d.ts` (hash: c72a90c781e078307e4c314a770b26a2)
...
interface __BaseEnv_Env {
	...
	AUTHENTICITY_CONTAINER_PROOF_ENABLED: "false";
	FORENSICS_CONTAINER: DurableObjectNamespace<import("./worker").LythausForensicsContainer>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker");
		durableNamespaces: "LythausForensicsContainer";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AUTHENTICITY_CONTAINER_PROOF_ENABLED">> {}
}
