/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=apps/lythaus-admin-api/wrangler.jsonc apps/lythaus-admin-api/src/worker-configuration.d.ts` (hash: b910576b45559ad43d3b7dbb268344eb)
