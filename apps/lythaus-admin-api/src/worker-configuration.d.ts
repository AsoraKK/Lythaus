/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=apps/lythaus-admin-api/wrangler.jsonc apps/lythaus-admin-api/src/worker-configuration.d.ts` (hash: bb69d1579578e337efbbedbb17b8f203)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "EXPECTED_HOSTNAMES" | "CORS_ALLOWED_ORIGINS" | "HYPERDRIVE_QUERY_CACHE_MODE" | "ACCESS_TEAM_DOMAIN" | "ACCESS_AUDIENCE" | "ACCESS_JWKS_URL" | "EXPECTED_DATABASE_TARGET" | "EXPECTED_DATABASE_SCHEMA_FINGERPRINT" | "EXPECTED_DATABASE_RELATION_COUNT" | "EXPECTED_DATABASE_SCHEMA_VERSION" | "EXPECTED_DATABASE_ROLE_CLASS" | "EXPECTED_DATABASE_BUDGET_LEDGER_APPLIED" | "AUTHENTICATED_ACCEPTANCE_PROVEN">> {}
}
