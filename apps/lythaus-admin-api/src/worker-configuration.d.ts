/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=apps/lythaus-admin-api/wrangler.jsonc apps/lythaus-admin-api/src/worker-configuration.d.ts` (hash: 6d4f3a0ac2843db4ca5ee1e0ff8e32d4)
