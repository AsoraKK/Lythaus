/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=apps/lythaus-admin-api/wrangler.jsonc apps/lythaus-admin-api/src/worker-configuration.d.ts` (hash: c63c0279519cd6cb51d652c449604894)
