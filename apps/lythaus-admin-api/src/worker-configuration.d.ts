/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=apps/lythaus-admin-api/wrangler.jsonc apps/lythaus-admin-api/src/worker-configuration.d.ts` (hash: 4d5c603576f763078eeb9cb5b036f33f)
