/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=apps/lythaus-jobs/wrangler.jsonc apps/lythaus-jobs/src/worker-configuration.d.ts` (hash: 1f7c975db3d6929769a78ed7a9249513)
...
interface __BaseEnv_Env {
	...
	AUTHENTICITY_TEXT_MODEL: "@cf/meta/llama-3.1-8b-instruct-fast";
	AUTHENTICITY_IMAGE_MODEL: "@cf/meta/llama-3.1-8b-instruct-fast";
	...
	COST_BUDGET_LIMIT_USD: "25";
	COST_BUDGET_WARNING_USD: "15";
	COST_BUDGET_OPTIONAL_ANALYSIS_USD: "18";
	COST_BUDGET_ESSENTIAL_ONLY_USD: "22";
	COST_BUDGET_DEEP_SCAN_STOP_USD: "25";
