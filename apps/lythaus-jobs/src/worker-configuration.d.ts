/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=apps/lythaus-jobs/wrangler.jsonc apps/lythaus-jobs/src/worker-configuration.d.ts` (hash: 53b08848004d9638716c832873e16ec1)
