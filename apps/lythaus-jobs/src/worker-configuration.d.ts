/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=apps/lythaus-jobs/wrangler.jsonc apps/lythaus-jobs/src/worker-configuration.d.ts` (hash: ebc92f246dbfcd35625cb3150def628d)
