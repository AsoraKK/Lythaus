/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=apps/lythaus-jobs/wrangler.jsonc apps/lythaus-jobs/src/worker-configuration.d.ts` (hash: 42af4eaacbf27a89cedd740beeab9c1b)
// Runtime types generated with workerd@1.20260811.1 2026-07-27 nodejs_compat
interface __BaseEnv_Env {
	...
	AUTHENTICITY_AI_ENABLED: "true";
	AUTHENTICITY_SHADOW_MODE: "true";
	AUTHENTICITY_ENFORCEMENT_ENABLED: "false";
	AUTHENTICITY_TEXT_MODEL: "@cf/openai/gpt-oss-20b";
	AUTHENTICITY_IMAGE_MODEL: "@cf/openai/gpt-oss-20b";
	...
	AUTH_ACCEPTANCE_EMAIL_LINK_BASE_URL: "http://localhost:8787/api/admin/production-auth-acceptance/email?context=" | "https://admin.lythaus.co/api/admin/production-auth-acceptance/email?context=";
	EXPECTED_DATABASE_TARGET: "development" | "main";
	EXPECTED_DATABASE_SCHEMA_FINGERPRINT: "8922ea383a1a9ff32b9b695e3b04bf5f56648d6a7371d8a35b49db7fae394ad8" | "REPLACE_WITH_POST_0016_SCHEMA_FINGERPRINT";
	EXPECTED_DATABASE_RELATION_COUNT: "77" | "REPLACE_WITH_POST_0016_RELATION_COUNT";
	EXPECTED_DATABASE_SCHEMA_VERSION: "unknown" | "0016_transactional_email_envelope_boundary.sql";
	EXPECTED_DATABASE_ROLE_CLASS: "login_non_superuser";
	COST_BUDGET_ENABLED: "true";
	COST_BUDGET_LIMIT_USD: "10";
	COST_BUDGET_WARNING_USD: "5";
	COST_BUDGET_OPTIONAL_ANALYSIS_USD: "7";
	COST_BUDGET_ESSENTIAL_ONLY_USD: "8";
	COST_BUDGET_DEEP_SCAN_STOP_USD: "9";
	COST_AUTHENTICITY_TEXT_ESTIMATE_USD: "0.004";
	COST_AUTHENTICITY_IMAGE_ESTIMATE_USD: "0.01";
	AI_GATEWAY_ID: "lythaus-ai";
...
declare namespace Cloudflare {
	...
	interface DevelopmentEnv {
		...
		EMAIL_VERIFICATION_BASE_URL: "http://localhost:4321/verify-email?token=";
		EMAIL_PASSWORD_RESET_BASE_URL: "http://localhost:4321/reset-password?token=";
		AUTH_ACCEPTANCE_EMAIL_LINK_BASE_URL: "http://localhost:8787/api/admin/production-auth-acceptance/email?context=";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "HYPERDRIVE_QUERY_CACHE_MODE" | "AUTHENTICITY_AI_ENABLED" | "AUTHENTICITY_SHADOW_MODE" | "AUTHENTICITY_ENFORCEMENT_ENABLED" | "AUTHENTICITY_TEXT_MODEL" | "AUTHENTICITY_IMAGE_MODEL" | "R2_ACCOUNT_ID" | "MEDIA_PROCESSING_ENABLED" | "MEDIA_QUARANTINE_BUCKET" | "MEDIA_APPROVED_BUCKET" | "EMAIL_PROVIDER_URL" | "EMAIL_PROVIDER_MODE" | "EMAIL_FROM" | "EMAIL_VERIFICATION_BASE_URL" | "EMAIL_PASSWORD_RESET_BASE_URL" | "AUTH_ACCEPTANCE_EMAIL_LINK_BASE_URL" | "EXPECTED_DATABASE_TARGET" | "EXPECTED_DATABASE_SCHEMA_FINGERPRINT" | "EXPECTED_DATABASE_RELATION_COUNT" | "EXPECTED_DATABASE_SCHEMA_VERSION" | "EXPECTED_DATABASE_ROLE_CLASS" | "COST_BUDGET_ENABLED" | "COST_BUDGET_LIMIT_USD" | "COST_BUDGET_WARNING_USD" | "COST_BUDGET_OPTIONAL_ANALYSIS_USD" | "COST_BUDGET_ESSENTIAL_ONLY_USD" | "COST_BUDGET_DEEP_SCAN_STOP_USD" | "COST_AUTHENTICITY_TEXT_ESTIMATE_USD" | "COST_AUTHENTICITY_IMAGE_ESTIMATE_USD" | "AI_GATEWAY_ID" | "EXPECTED_DATABASE_BUDGET_LEDGER_APPLIED" | "AUTHENTICATED_ACCEPTANCE_PROVEN">> {}
}
