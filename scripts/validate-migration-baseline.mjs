...
const requiredTables = [
  ...
  'system.outbox_events', 'system.transactional_email_outbox', 'system.consumer_inbox', 'system.idempotency_keys', 'system.audit_events', 'system.feature_flags',
