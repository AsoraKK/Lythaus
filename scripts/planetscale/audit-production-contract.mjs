...
try {
  ...
  const verifierOutput = String(verifier.stdout ?? '')
    .split(/\r?\n/)
    .filter((line) => line.startsWith('Observed post-0013 schema fingerprint:')
      || line.startsWith('Observed post-0013 relation count:')
      || line.startsWith('Observed post-0013 catalog SHA-256:')
